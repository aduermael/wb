...
final class DaemonClient {
    ...
    private func ensureCompatibleDaemon() throws {
        ...
        do {
            ...
            daemonLog("daemon not reachable or unresponsive; replacing daemon socket=\(socketPath) error=\(error.localizedDescription)")
    ...
    private func stopIncompatibleDaemon() throws {
        ...
        daemonLog("terminating incompatible daemon pids=\(processIDs.map(String.init).joined(separator: ",")) signal=TERM")
